...
public class ToolUtil {
    ...
    public static Logger logger = Logger.getLogger(ToolUtil.class);
...
//	}
     ...
     * @return
     */
    public static String insertString(String indexStr,String str,String insertStr){
        StringBuilder sb = new StringBuilder(str);//构造一个StringBuilder对象
        String s = sb.insert(sb.indexOf(indexStr), "   value=\"${item." + insertStr + "}\" ").toString();//插入指定的字符串
        return s;
    }

    public static  List<Object> ObjectToSelectList(String key,String value,List<Object> list){
        HashMap<String, Object> HashMap = new HashMap<>();
        ArrayList<Object> returnList = new ArrayList<>();
//        for (Object l:list){
//            if (l instanceof Map){
//                Object o = ((Map) l).get(key);
//                ((Map) l).get()
//            }
//        }
        return returnList;
