package com.stylefeng.gunSelf.rest.modular.auth.converter;
...
import com.stylefeng.gunSelf.core.util.MD5Util;
import com.stylefeng.gunSelf.rest.common.exception.BizExceptionEnum;
import com.stylefeng.gunSelf.rest.config.properties.JwtProperties;
import com.stylefeng.gunSelf.rest.modular.auth.security.DataSecurityAction;
...
public class WithSignMessageConverter extends FastJsonHttpMessageConverter {
    ...
    public Object read(Type type, Class<?> contextClass, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        if (encrypt.equals(baseTransferEntity.getSign())) {
            ...
            throw new FadpException(BizExceptionEnum.SIGN_ERROR);
        }
