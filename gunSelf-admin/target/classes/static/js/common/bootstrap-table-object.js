...
(function () {
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    height: this.height,
                    exportTypes:[ 'csv', 'txt', 'sql', 'doc', 'excel', 'xlsx'],//导出文件的类型
        ...
        getData: function (parms) {
            if (typeof parms != "undefined") {
                this.btInstance.bootstrapTable('getData', parms);
                console.log("调用了第一个方法");
            } else {
                console.log("调用了第二个方法");
                return this.btInstance.bootstrapTable('getOptions').totalRows;
            }
        }
    };
