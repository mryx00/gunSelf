...
BlogBackimg.initColumn = function () {
    return [
        {field: 'selectItem', checkbox: true},
            ...
            {title: '图片预览', field: 'imgAddr', visible: true, align: 'center', valign: 'middle',
                formatter: function (value, row, index) {
                    if (row.imgAddr !== "") {
                        return '<img style="width: 60px;height: 60px" src="/pictures/' + row.imgAddr + '" class="img-rounded" >';
                    } else {
                        return null;
                    }
                }
