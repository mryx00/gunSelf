...
MgrUser.initColumn = function () {
    var columns = [
        ...
        {title: '头像', field: 'avatar',  align: 'center', valign: 'middle',formatter: function(value,row,index){
            if (row.avatar!==""){
                return '<img style="width: 60px;height: 60px" src="/pictures/'+row.avatar + '" class="img-rounded" >';
            }else {
                return null;
            }
