...
import com.stylefeng.gunSelf.modular.system.service.IDictService;
...
import static com.stylefeng.gunSelf.core.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new FadpException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new FadpException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
