package com.stylefeng.gunSelf.modular.code.factory;


import com.stylefeng.gunSelf.GunSelfApplication;
import com.stylefeng.gunSelf.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("stylezhang");
        genQo.setProjectPackage(GunSelfApplication.class.getPackage().getName());
