...
import com.stylefeng.gunSelf.core.common.constant.dictmap.MenuDict;
...
import com.stylefeng.gunSelf.modular.system.model.Menu;
import com.stylefeng.gunSelf.modular.system.service.IMenuService;
import com.stylefeng.gunSelf.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new FadpException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new FadpException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
