package com.stylefeng.gunSelf.system;

import com.stylefeng.gunSelf.base.BaseJunit;
import com.stylefeng.gunSelf.modular.system.dao.DeptMapper;
...
public class DeptTest extends BaseJunit {
    ...
    public void listTest() {
        List<Map<String, Object>> list = this.deptMapper.list("总公司","N");
