 ...
 */
public class FadpGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/gunSelf?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.stylefeng.gunSelf.admin.common.persistence.model");
        packageConfig.setMapper("com.stylefeng.gunSelf.admin.common.persistence.dao");
        packageConfig.setXml("com.stylefeng.gunSelf.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.stylefeng.gunSelf.admin");
        contextConfig.setCoreBasePackage("com.stylefeng.gunSelf.core");
        contextConfig.setBizChName("字典管理");
        contextConfig.setBizEnName("sysDict");
        contextConfig.setModuleName("system");
        contextConfig.setProjectPath("D:\\ideaSpace\\gunSelf\\gunSelf-admin");//写自己项目的绝对路径
