...
public class ContextConfig {
    ...
    private String templatePrefixPath = "fadpTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\gunSelf";//模板输出的项目目录
    ...
    private String proPackage = "com.stylefeng.gunSelf.admin";
    private String coreBasePackage = "com.stylefeng.gunSelf.core";
    private String modelBasePackageName = "com.stylefeng.gunSelf.modular";
    private String modelPackageName = "com.stylefeng.gunSelf.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.stylefeng.gunSelf.modular.system.dao";    //model的dao
