package com.stylefeng.gunSelf.generator.engine.base;

import com.baomidou.mybatisplus.generator.config.po.TableField;
import com.baomidou.mybatisplus.generator.config.po.TableInfo;
import com.stylefeng.gunSelf.generator.action.model.MyTableField;
import com.stylefeng.gunSelf.generator.engine.config.*;
...
public class AbstractTemplateEngine {
    ...
    public List<MyTableField> getMyTableFields() {
        return myTableFields;
    }

    public void setMyTableFields(List<MyTableField> myTableFields) {
        this.myTableFields = myTableFields;
    }

    protected TableField KeyField;                           //表主键的信息

    protected List<MyTableField> myTableFields;              //自己封装的字段信息
