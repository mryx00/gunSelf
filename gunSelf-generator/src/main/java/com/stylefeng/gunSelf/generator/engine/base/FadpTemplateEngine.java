 ...
 */
public abstract class FadpTemplateEngine extends AbstractTemplateEngine {

    private GroupTemplate groupTemplate;
    /*new FadpTemplateEngine()对象调用初始化方法*/
    public FadpTemplateEngine() {
        initBeetlEngine();
    }
    ...
    protected void configTemplate(Template template) {
        ...
        /*绑定表格的主键信息*/
        template.binding("keyField",super.KeyField);
        /*绑定字段的样式以及验证信息*/
        template.binding("myTableFields",super.myTableFields);
    }

    /*生成通用的文件,主要方法是获取相应的pageTemplate*/
